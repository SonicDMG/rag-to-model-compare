...
export function DirectUploadResult({ status, tokenCount, loadTime, warnings, processedText, error, hasImages, imageCount, fileSize, skipped, existingDocument, message }: DirectUploadResultProps) {
  ...
  return (
    <div className={`
      ...
      ${status === 'success'
        ? skipped ? 'bg-yellow-500/10 border-yellow-500/20' : 'bg-blue/10 border-blue/20'
      ...
      {status === 'success' && skipped ? (
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-yellow-400">File Already Processed - Skipped</span>
          </div>
          ...
          <div className="ml-7 space-y-2">
            ...
            <div className="mt-3 p-2 bg-blue/10 border border-blue/20 rounded-unkey-md">
              <p className="text-xs text-blue">
                💡 <span className="font-semibold">Tip:</span> To re-process this file, delete it from OpenSearch first or rename the file before uploading.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col flex-grow">
          <div className="space-y-3">
            ...
            {hasImages && imageCount !== undefined && (
              <div className="ml-7">
                <div className="p-2 bg-blue/20 border border-blue/30 rounded-unkey-md">
          ...
          {processedText && (
            <div className="mt-auto pt-3 ml-7">
              ...
              {showText && (
                <div className="mt-2 p-3 bg-unkey-gray-900 border border-blue/30 rounded-unkey-md max-h-96 overflow-auto">
