...
const COLOR_OPTIONS = [
  { value: 'zinc', label: 'Zinc', bgClass: 'bg-zinc-600', borderClass: 'border-zinc-600' },
...
const ICON_OPTIONS: Array<{ name: string; icon: LucideIcon; label: string }> = [
  ...
  { name: 'map', icon: LucideIcons.Map, label: 'Map' },
  { name: 'image', icon: LucideIcons.FileImage, label: 'Image' },
  { name: 'layers3', icon: LucideIcons.Layers3, label: 'Layers' },
  ...
  { name: 'messagesSquare', icon: LucideIcons.MessagesSquare, label: 'Messages' },
  { name: 'squareStack', icon: LucideIcons.SquareStack, label: 'Stack' },
  { name: 'ghost', icon: LucideIcons.Ghost, label: 'Ghost' },
  { name: 'gem', icon: LucideIcons.Gem, label: 'Gem' },
  { name: 'swords', icon: LucideIcons.Swords, label: 'Swords' },
  { name: 'bolt', icon: LucideIcons.Bolt, label: 'Bolt' },
  { name: 'shield', icon: LucideIcons.Shield, label: 'Shield' },
  { name: 'hammer', icon: LucideIcons.Hammer, label: 'Hammer' },
  { name: 'globe', icon: LucideIcons.Globe, label: 'Globe' },
  { name: 'hardDrive', icon: LucideIcons.HardDrive, label: 'Hard Drive' },
  { name: 'upload', icon: LucideIcons.Upload, label: 'Upload' },
  { name: 'cable', icon: LucideIcons.Cable, label: 'Cable' },
  { name: 'shoppingCart', icon: LucideIcons.ShoppingCart, label: 'Cart' },
  { name: 'shoppingBag', icon: LucideIcons.ShoppingBag, label: 'Bag' },
];
...
export function FilterForm({ filter, onSubmit, onCancel, isSubmitting = false }: FilterFormProps) {
  const [formData, setFormData] = useState<FilterFormData>({
    ...
    color: filter?.queryData?.color || 'zinc',
